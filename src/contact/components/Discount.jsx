            ...
            <div className="container">
                <div className="row align-items-center justify-content-between">
                    ...
                    <div className="col-lg-4">
                        <p className="mb-0"><a href={discountData.discountlink} className="btn btn-outline-white text-white btn-md btn-pill px-5 font-weight-bold btn-block">{discountData.discountbuttontext}</a></p>
                    </div>
                </div>
            </div>
        </div>
